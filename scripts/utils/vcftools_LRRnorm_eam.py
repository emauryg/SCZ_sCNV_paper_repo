...
df_IllumOmniExpress = all_study_data[all_study_data.Array == "IllumOmniExpress"]
df_IllumOmniExpress_plus = all_study_data[all_study_data.Array == "IllumOmniExpress+"]



# load vcfs
vcf_IllumOmniExpress = pysam.VariantFile("/home/pgccnv/somaticcnv/mocha_output/IllumOmniExpress.mocha.bcf")
vcf_IllumOmniExpress_plus = pysam.VariantFile("/home/pgccnv/somaticcnv/mocha_output/IllumOmniExpress+.mocha.bcf")
...
def sample_to_VCF(sample):
	if ((df_IllumOmniExpress.alt_identifier == sample).any() | (df_IllumOmniExpress.identifier == sample).any()):
        vcf = vcf_IllumOmniExpress
    elif ((df_IllumOmniExpress_plus.alt_identifier == sample).any() | (df_IllumOmniExpress_plus.identifier == sample).any()):
        vcf = vcf_IllumOmniExpress_plus
	else:
